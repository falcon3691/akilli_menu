...
namespace akilli_menu
{
    public partial class Form5 : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            string isim1 = "masa01_zeytinyagli.txt";
            string tamYol1 = yol1 + isim1;
            hesapy.Clear();
            string yazilacak = "ZEYTİNYAĞLILAR\n" +
                               "--------------\n" +
                               "Barbunya             " + a1.ToString() + "   " + b1.ToString() + "TL\n" +
                               "Biber Dolması     " + a2.ToString() + "   " + b2.ToString() + "TL\n" +
                               "Enginar               " + a3.ToString() + "   " + b3.ToString() + "TL\n" +
                               "Karnıyarık            " + a4.ToString() + "   " + b4.ToString() + "TL\n" +
                               "Sarma                 " + a5.ToString() + "   " + b5.ToString() + "TL\n" +
                               "?" + sonuc.ToString() +
                               "\n@";
